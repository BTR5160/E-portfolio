          ...
          {skillCategories.map((category, index) => (
            ...
            >
              ...
              <div className="text-center mb-6">
                <div className={`inline-flex p-4 rounded-full bg-gradient-to-r ${category.color} shadow-lg text-white text-3xl`}>
                  {category.pieceSymbol}
                </div>
                <h3 className={`text-lg font-semibold mt-3 ${darkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                  {category.piece}
                </h3>
              </div>
